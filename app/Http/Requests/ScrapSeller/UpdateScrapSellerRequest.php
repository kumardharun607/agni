...
class UpdateScrapSellerRequest extends FormRequest
{
    ...
    {
        $id = $this->route('scrap_seller')?->id ?? $this->route('scrap_seller');
        ...
        return [
            ...
            'mobile' => ['required', 'string', 'regex:/^[0-9]{10,15}$/', Rule::unique('scrap_sellers', 'mobile')->ignore($id)],
            'owner_type' => ['nullable', 'string', 'max:100'],
            'address' => ['required', 'string'],
            'gst_no' => ['nullable', 'string', 'max:30'],
            'pan_no' => ['nullable', 'string', 'max:20'],
            'email' => ['nullable', 'email', 'max:255', Rule::unique('scrap_sellers', 'email')->ignore($id)],
