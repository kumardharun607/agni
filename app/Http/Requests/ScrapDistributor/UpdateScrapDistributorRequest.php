...
class UpdateScrapDistributorRequest extends FormRequest
{
    ...
    {
        $id = $this->route('scrap_distributor')?->id ?? $this->route('scrap_distributor');

        return [
            'rep_id' => ['nullable', 'string', 'max:50'],
            'name' => ['required', 'string', 'max:255'],
            'customer_name' => ['required', 'string', 'max:255'],
            'mobile' => ['required', 'string', 'regex:/^[0-9]{10,15}$/', Rule::unique('scrap_distributors', 'mobile')->ignore($id)],
            ...
            'email' => ['nullable', 'email', 'max:255', Rule::unique('scrap_distributors', 'email')->ignore($id)],
