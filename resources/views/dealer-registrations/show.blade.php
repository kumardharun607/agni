    ...
    <div class="mx-auto max-w-6xl">
        ...
        <div class="mb-6 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-slate-500">
                        Read-only view. Use Edit to change this registration.
                    </p>
                </div>
            ...
            <div class="flex flex-wrap gap-3">
                ...
                {{-- PDF --}}
                <a href="{{ route('dealer-registrations.pdf', $dealer->id) }}"
                   target="_blank"
        ...
        @php
            ...
            |
            | 2. /storage/path/image.jpg
            |
            | 3. storage/path/image.jpg
            |
            | 4. path/image.jpg
            |
            */
            ...
            */
            ...
            if (!empty($dealer->photo_upload2)) {
                ...
                if (
                    ...
                    $godownImageUrl = asset(
                        ltrim($godownImagePath, '/')
                    );

                } else {

                    $godownImageUrl = asset(
                        'storage/' . ltrim($godownImagePath, '/')
                    );
        ...
        <div class="mb-6 overflow-hidden rounded-2xl border border-slate-300 bg-white shadow-lg">
            ...
            <div class="border-b border-orange-200 bg-orange-50 px-5 py-4 sm:px-7">
                ...
                <h2 class="text-lg font-bold text-slate-800">
                    ...
                    <i class="bi bi-card-checklist mr-2 text-orange-700"></i>
            ...
            <div class="grid gap-5 p-5 sm:grid-cols-2 sm:p-7 lg:grid-cols-4">
                ...
                <div class="detail-item">
                    <p class="detail-label">Application No</p>
                    <p class="detail-value">
                        {{ $dealer->application_no }}
                    </p>
                </div>

                <div class="detail-item">
                    <p class="detail-label">Alias ID</p>
                    <p class="detail-value">
                        {{ $dealer->alias_id ?: '-' }}
                    </p>
                </div>
                ...
                <div class="detail-item">
                    <p class="detail-label">Dealer Type</p>
                    <p class="detail-value">
                        {{ $dealer->dealers_type ?: '-' }}
                    </p>
                </div>
                ...
                <div class="detail-item">
                    <p class="detail-label">Manager Status</p>
                    <p class="detail-value">
                        {{ $dealer->manager_status ?: 'Pending' }}
                    </p>
                </div>

                <div class="detail-item">
                    <p class="detail-label">Admin Status</p>
                    <p class="detail-value">
                        {{ $dealer->admin_status ?: 'Pending' }}
                    </p>
                </div>

                <div class="detail-item">
                    <p class="detail-label">Manager Name</p>
                    <p class="detail-value">
                        {{ $dealer->manager_name ?: '-' }}
                    </p>
                </div>
        ...
        <div class="mb-6 overflow-hidden rounded-2xl border border-slate-300 bg-white shadow-lg">
            ...
            <div class="border-b border-orange-200 bg-orange-50 px-5 py-4 sm:px-7">
                ...
                <h2 class="text-lg font-bold text-slate-800">
                    ...
                    <i class="bi bi-shop mr-2 text-orange-700"></i>
            ...
            <div class="grid gap-5 p-5 sm:grid-cols-2 sm:p-7 lg:grid-cols-3">
                ...
                <div class="detail-item">
                    <p class="detail-label">Owner Name</p>
                    <p class="detail-value">
                        {{ $dealer->n_of_propriter ?: '-' }}
                    </p>
                </div>

                <div class="detail-item">
                    <p class="detail-label">Shop Established Year</p>
                    <p class="detail-value">
                        {{ $dealer->shop_est_yr ?: '-' }}
                    </p>
                </div>
                ...
                <div class="detail-item">
                    <p class="detail-label">Age of Business</p>
                    <p class="detail-value">
                        {{ $dealer->age_of_bus ?: '-' }}
                    </p>
                </div>
                ...
                <div class="detail-item">
                    <p class="detail-label">Mobile No</p>
                    <p class="detail-value">
                        {{ $dealer->mobile_no ?: '-' }}
                    </p>
                </div>
                ...
                <div class="detail-item">
                    <p class="detail-label">Alternate Mobile 1</p>
                    <p class="detail-value">
                        {{ $dealer->alter_mobno1 ?: '-' }}
                    </p>
                </div>
                ...
                <div class="detail-item">
                    <p class="detail-label">Alternate Mobile 2</p>
                    <p class="detail-value">
                        {{ $dealer->alter_mobno2 ?: '-' }}
                    </p>
                </div>
                ...
                <div class="detail-item sm:col-span-2 lg:col-span-3">
        ...
        <div class="mb-6 overflow-hidden rounded-2xl border border-slate-300 bg-white shadow-lg">
            ...
            <div class="border-b border-orange-200 bg-orange-50 px-5 py-4 sm:px-7">
                ...
                <h2 class="text-lg font-bold text-slate-800">
                    ...
                    <i class="bi bi-bank mr-2 text-orange-700"></i>
            ...
            <div class="grid gap-5 p-5 sm:grid-cols-2 sm:p-7 lg:grid-cols-3">
                ...
                <div class="detail-item">
                    <p class="detail-label">Name of the Bank</p>
                    <p class="detail-value">
                        {{ $dealer->name_add_bank ?: '-' }}
                    </p>
                </div>

                <div class="detail-item">
                    <p class="detail-label">Type of A/C</p>
                    <p class="detail-value">
                        {{ $dealer->type_of_ac ?: '-' }}
                    </p>
                </div>
                ...
                <div class="detail-item">
                    <p class="detail-label">Status of Firm</p>
                    <p class="detail-value">
                        {{ $dealer->status_of_firm ?: '-' }}
                    </p>
                </div>

                <div class="detail-item">

                    <p class="detail-label">Own / Rental Shop</p>

                    <p class="detail-value">

                        {{
                            \App\Http\Controllers\DealerRegistration\DealerRegistrationController::ownRentOptions()[$dealer->own_rent]
                            ?? ($dealer->own_rent ?: '-')
                        }}
                ...
                <div class="detail-item">
                    <p class="detail-label">Shop Area (SQ.FT)</p>
                    <p class="detail-value">
                        {{ $dealer->shop_areasq ?: '-' }}
                    </p>
                </div>
                ...
                <div class="detail-item">
                    <p class="detail-label">Godown Area (SQ.FT)</p>
                    <p class="detail-value">
                        {{ $dealer->godown_areasq ?: '-' }}
                    </p>
                </div>

                <div class="detail-item">
                    <p class="detail-label">Other Business</p>
                    <p class="detail-value">
                        {{ $dealer->other_business ?: '-' }}
                    </p>
                </div>

                <div class="detail-item">
                    <p class="detail-label">Agni Expected Tonnage</p>
                    <p class="detail-value">
                        {{ $dealer->agni_exp_ton ?: '-' }}
                    </p>
                </div>
                ...
                <div class="detail-item">
                    <p class="detail-label">Dealer Total Capacity</p>
                    <p class="detail-value">
                        {{ $dealer->dealer_total_capacity ?: '-' }}
                    </p>
                </div>
        ...
        <div class="mb-6 overflow-hidden rounded-2xl border border-slate-300 bg-white shadow-lg">
            ...
            <div class="border-b border-orange-200 bg-orange-50 px-5 py-4 sm:px-7">
                ...
                <h2 class="text-lg font-bold text-slate-800">
                    ...
                    <i class="bi bi-tags mr-2 text-orange-700"></i>
                    ...
                    <table class="w-full min-w-[420px] border-collapse text-left text-sm">
                        ...
                        <thead class="bg-slate-100">
                            ...
                            <tr>
                                ...
                                <th class="border border-slate-300 px-4 py-2 font-bold">
                                    S.No
                                </th>
                        ...
                        <tbody>
                            ...
                            <tr class="bg-slate-50 font-semibold">
                                ...
                                <td class="border border-slate-300 px-4 py-2">
                                    Commercial:
                                    {{ $dealer->commercial_brand ?: '-' }}
                                </td>

                                <td class="border border-slate-300 px-4 py-2">
                                    {{ $dealer->commercial_ton ?: '-' }}
                                </td>
                        ...
                        <tbody>
                            ...
                            @for ($i = 1; $i <= 4; $i++)
                                ...
                                <tr>
                                    ...
                                    <td class="border border-slate-300 px-4 py-2">
                                        {{ $dealer->{'cement_brand'.$i} ?: '-' }}
                                    </td>

                                    <td class="border border-slate-300 px-4 py-2">
                                        {{ $dealer->{'cement_month_cement'.$i} ?: '-' }}
                                    </td>
        ...
        <div class="mb-6 overflow-hidden rounded-2xl border border-slate-300 bg-white shadow-lg">
            ...
            <div class="border-b border-orange-200 bg-orange-50 px-5 py-4 sm:px-7">
                ...
                <h2 class="text-lg font-bold text-slate-800">
                    ...
                    <i class="bi bi-signpost-split mr-2 text-orange-700"></i>
        ...
        <div class="mb-10 overflow-hidden rounded-2xl border border-slate-300 bg-white shadow-lg">
            ...
            <div class="grid gap-5 p-5 sm:grid-cols-2 sm:p-7">
                ...
                <div class="detail-item">
                    ...
                    <p class="detail-label">
                        Sr. Marketing Manager (Manager Name)
                    </p>
            ...
            <div class="grid gap-6 border-t border-slate-200 p-5 sm:grid-cols-2 sm:p-7">
                ...
                <div class="rounded-xl border border-slate-300 bg-slate-50 p-5 text-center">
                    ...
                    @if($shopImageUrl)
                        ...
                        <p id="shop-image-error"
                           class="hidden mt-3 text-sm font-medium text-red-500">
