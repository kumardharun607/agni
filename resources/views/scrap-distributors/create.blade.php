...
@section('title','Add Scrap Distributor')

@section('page_title','Add Scrap Distributor')

@section('content')

<x-breadcrumb
    title="Add Scrap Distributor"
    parent="Masters"
...
<form action="{{ route('scrap-distributors.store') }}"
      method="POST"
    ...
    <div class="bg-white rounded-xl shadow border">
        ...
        <div class="border-b px-6 py-4">
            <h2 class="text-xl font-bold">Add Scrap Distributor</h2>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5 p-6">
            ...
            <div>
                ...
                <input type="text" name="rep_id" value="{{ old('rep_id') }}"
            ...
            <div>
                ...
                <select name="pincode_id" required
                    ...
                    @foreach($pincodes as $pincode)
                        <option value="{{ $pincode->id }}" @selected(old('pincode_id') == $pincode->id)>
                            {{ $pincode->pincode }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="address" rows="3" required
                          class="w-full border rounded-lg px-4 py-2 mt-1 @error('address') border-red-500 @enderror">{{ old('address') }}</textarea>
