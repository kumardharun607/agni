@extends('layouts.app')
@section('title','Import Brands')
@section('content')
@include('components.alert')
<div class="bg-white rounded-lg shadow-md p-6">
    <h2 class="text-3xl font-bold mb-6">Import Brands</h2>
    <form action="{{ route('brands.import.store') }}" method="POST" enctype="multipart/form-data" data-ajax-skip>
        @csrf
        ...
        <div class="flex gap-3">
            ...
            <a href="{{ route('brands.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-6 py-2 rounded">Cancel</a>
        </div>
    </form>
</div>
@endsection
