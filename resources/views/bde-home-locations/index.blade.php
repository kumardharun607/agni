...
@section('title','BDE Home Locations')

@section('page_title','BDE Home Locations')

@section('content')

<x-breadcrumb
    title="BDE Home Locations"
    parent="Masters"
    child="BDE Home Locations"
    :button="'<div class=\'flex gap-2\'>
        <a href='.route('bde-home-locations.import').' class=\'bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg\'>
            Import Excel
        </a>

        <a href='.route('bde-home-locations.export').' data-ajax-skip download class=\'bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg\'>
            Export Excel
        </a>

        <a href='.route('bde-home-locations.create').' class=\'bg-red-700 hover:bg-red-800 text-white px-5 py-2 rounded-lg\'>
            + Add BDE Home Location
        </a>
    </div>'"
/>
...
<div class="bg-white rounded-xl shadow border border-gray-200">
    ...
    <div class="p-5 border-b">
        ...
        <div class="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
            ...
            <div class="w-full md:w-72">
                ...
                <input
                    type="text"
                    id="searchBdeHomeLocation"
                    placeholder="Search BDE Home Location..."
    ...
    <div class="overflow-x-auto">
        ...
        <table id="bdeHomeLocationTable" class="min-w-full">
            ...
            <thead class="bg-gray-100">
                ...
                <tr>
                    ...
                    <th class="px-4 py-3 text-left">BDE Name</th>
            ...
            <tbody>
                ...
                @forelse($bdeHomeLocations as $location)
                ...
                <tr class="border-b hover:bg-gray-50">
                    ...
                    <td class="px-4 py-3">
                        ...
                        <div class="flex justify-center items-center gap-2">
                            ...
                            <a href="{{ route('bde-home-locations.edit',$location->id) }}"
                               title="Edit"
                            ...
                            <button type="button" title="Delete"
                                onclick="deleteBdeHomeLocation({{ $location->id }}, this)"
...
$("#searchBdeHomeLocation").keyup(function(){

    let value=$(this).val().toLowerCase();

    $("#bdeHomeLocationTable tbody tr").filter(function(){
...
function deleteBdeHomeLocation(id, btn){

    let $row = $(btn).closest('tr');

    Swal.fire({
        title:'Are you sure?',
        text:'This BDE Home Location will be deleted permanently.',
        icon:'warning',
